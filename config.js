...
module.exports = {
  ...
  ownername: process.env.Owner_Name || "Dark D",
  ownernumber: process.env.Owner_Number || "94789528431",
  ...
  sessionId: process.env.SESSION_ID || "N0dNUVZ_Queen-Anya_GZ_Queen-Anya_E4=", 
